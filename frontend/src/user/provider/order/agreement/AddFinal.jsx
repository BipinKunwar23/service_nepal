...
const AddFinal = () => {
  ...
  return (
    <form action="" onSubmit={handleSubmit(onSubmit)}>
        <div className="my-3">
      <p className="text-lg font-semibold text-gray-600 text-center ">Final Agreement</p>
    </div>
      <section className="grid grid-cols-3  text-slate-600">
        <div>
          <p className="ml-4 font-bold text-lg">Terms and Condition</p>
          <div>
        ...
        <div>
          <p className="ml-4 font-bold text-lg">Quality Assurance</p>
          <div>
            <div className="selected-field">
