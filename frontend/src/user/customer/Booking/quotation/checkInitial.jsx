...
import { useCheckInitialAgreementQuery,useAcceptInitialAgreementMutation } from "../../../../Api/agreementApi";
...
const checkInitial = () => {
  ...
  const [acceptAgreement,{isLoading:isAccept}] = useAcceptInitialAgreementMutation();
  ...
  if (Object.keys(initial).length===0) {
    return <div className="p-5">
      <p className="text-center">No Initial Agreemnet is Made</p>
    </div>;
  }
  return (
    <section className="shadow shadow-gray-300 mt-2 py-5">
