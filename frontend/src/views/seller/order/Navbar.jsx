...
const orderNavbar = () => {
  ...
  return (
    <nav className="flex place-content-center order-dashboard p-4 box-border bg-gray-100 w-[80Vw] mx-auto">
        <ul className=" p-2 flex gap-12 text-red-500 font-bold  ">
          <li className="">
            <NavLink to={`${orderId}`}>Order</NavLink>
          </li>
          <li>
            <NavLink to={`agreement/${orderId}`}>Agreeement</NavLink>
          </li>
          <li>
            <NavLink to={`status/${orderId}`}>Progress</NavLink>
          </li>
          <li>
         <button 
         onClick={()=>{
