...
const SellerNavbar = ({ profile }) => {
  ...
  return (
    <div className="  flex  gap-5  bg-white text-slate-500">
      <div className="w-[20Vw] grid place-content-center border-r p-4  py-6 box-border">
        <p
      ...
      <div className=" text-gray-700 grid justify-end flex-1 p-6">
        <ul className=" flex-1 flex gap-10   place-content-center ">
          ...
          <li className="p-2">
            <NavLink to={`/user/${name}/notifications`} className="w-full flex">
              ...
              <sup className={` text-[1.1em] ${count.notification>0 && "bg-red-600"}  rounded-full w-5 h-5 grid place-content-center p-2 text-white`}>{count.notification>0 && count.notification}</sup>
            </NavLink>
          </li>
          <li className="p-2">
