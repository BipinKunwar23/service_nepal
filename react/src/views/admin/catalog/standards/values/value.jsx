...
import { useGetValueByStandardQuery } from "../../../../../api/admin/optionApi";
...
const StandardValue = () => {
  ...
  return (
    <section className="p-4  ">
      <div className="flex justify-between my-8 gap-10">
        <div>
          <input
            ...
            placeholder="Search Standard's values"
          />
        </div>
        {!addItem && (
          <div>
      ...
      {addItem && <AddValue setAddItem={setAddItem} />}
      <table className="w-full box-border table-auto bg-white border  border-gray-200  ">
        <thead>
          <tr className="text-left  bg-red-800 text-white ">
            ...
            <th className="py-2 px-4 border-b">Standard Term</th>
